 ...
 * to the FrenchLoader.jar and loads the translations
	...
	public void run(){
		...
		try{
			...
			try {
				...
				JOptionPane.showMessageDialog(new JFrame(), "[FrenchLoader] ERROR: \n" + e.getMessage());
				out.print("[ERROR]" + e.getMessage());
				e.printStackTrace();
				System.exit(0);
			}
		}catch(Exception e){
			JOptionPane.showMessageDialog(new JFrame(), "[FrenchLoader] Can't open output stream!");
			e.printStackTrace();
			System.exit(0);
		}
	}
